 ...
 const Fotter = () => {
   return (
     <>
     <div className=' w-full h-screen flex justify-between bg-zinc-900 p-20'>
        <div className='w-1//2 h-full  flex flex-col justify-between '>
           <div className='heading '>
                <h1 className='text-[6vw] uppercase leading none font-semibold tracking-tight' >Eye -</h1>
                <h1 className='text-[6vw] uppercase leading none  font-semibold  leading-none tracking-tight' >Opening</h1>
           </div>
        ...
        <div className='w-1/2 flex flex-col '>
             <h1 className='text-[4vw] mt-8 flex uppercase leading none  font-semibold  leading-none tracking-tight' >Presentation</h1>
          <div className='flex px-5'>
          <div className='w-1/2 h-full mt-7 '>
                <div className='linkssec1  tracking-tight  px-2 '>
                    <h1 className='text-[14px]'>Si:</h1>
                <div className='mt-3 flex flex-col underline'>
                    <a href="https://www.facebook.com/awais.manais.75">facebook.</a>
                    <a href="https://www.instagram.com/aws._.x36/?igsh=ZGUzMzM3NWJiOQ%3D%3D#">instagram.</a>
                    </div>
                       
                </div>
                <div className='linkssec2 mt-6  px-2 '>
                    <h1 className='text-[14px]'>L:</h1>
                <div className='mt-3 flex cursor-default flex-col underline'>
                         <h1>2019-2025 W 4th Ave</h1>
                        <h1>Lahore Pakistan</h1>
                    </div>
                <div className='mt-3 flex cursor-default flex-col underline'>
                   <h1>63-A Johar Town</h1>
                   <h1>Architect Society</h1>
                </div>
                       
                </div>
                <div className='linkssec2 mt-6   px-2 '>
                    <h1>E:</h1>
                    <h1 className='underline'>awaisakram182@gmail.com</h1>
                </div>
           </div>
           <div className='2ndhalf flex flex-col px-9  mt-35 '>
                  <h1 className=''>H:</h1>
                  <a className='underline' href="https://www.facebook.com/awais.manais.75">facebook.</a>
                  <a className='underline' href="https://www.instagram.com/aws._.x36/?igsh=ZGUzMzM3NWJiOQ%3D%3D#">instagram.</a>
           </div>
